...
function South_Carolina() {
  const [north_carolina, setSouth_Carolina] = useState([]);
  ...
  return (
    <div className="main-container">
      <h1 className="state-name">South Carolina Homes</h1>
      {!loadingData ? (
        <div className="houses">
          {north_carolina
            .filter((array) => array.location.includes("SC"))
            .map((house, key) => (
